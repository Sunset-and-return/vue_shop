<template>
  <div>
    ...
    <el-card>
      ...
      <!-- tab 页签区域 -->
      <el-tabs style="text-align: left;" v-model="activeName" @tab-click="handleClick">
        <!-- 添加动态参数面板 -->
          ...
          <el-table :data="manyTableData" border stripe>
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-tag :key="i" v-for="(item, i) in scope.row.attr_vals" closable :disable-transitions="false"
    ...
    <!-- 添加参数对话框 -->
    <el-dialog class="cat_left" :title="'添加' + titleText" :visible.sync="addDialogVisible" width="50%"
    ...
    <!-- 编辑参数对话框 -->
    <el-dialog class="cat_left" :title="'修改' + titleText" :visible.sync="editDialogVisible" width="50%"
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 文本框自动获得焦点
      // $nextTick 的作用就是：就是当页面上的元素被重新渲染之后，才会指定回调函数中的代码
      this.$nextTick(_ => {
